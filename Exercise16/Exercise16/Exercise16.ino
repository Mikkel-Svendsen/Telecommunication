/*
  16a. A server is a computer which has the responsibility to sent and recieve messages/data from other devices.

  16b. A GET request is a HTTP method that request data from a specified ressource.
...
void setup() {
  ...
  Serial.println();
  wifiMulti.addAP("Jakob - iPhone", "kodekodeadad");  // add Wi-Fi networks you want to connect to
